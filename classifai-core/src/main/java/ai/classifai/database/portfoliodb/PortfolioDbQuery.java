...
public class PortfolioDbQuery
{
    ...
    private final static String GET_ALL_PROJECTS_FOR_ANNOTATION_TYPE = "select project_name, starred, is_loaded, created_date from Portfolio where annotation_type = ?";
